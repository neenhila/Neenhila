module.exports = {
    ...
    execute(message, client, Discord){
        message.channel.send("Data yükleniyor.").then(msg => {
            ...
            .addFields(
                {name: "<a:RainbowOkGif:869301898946158763> Bot Pingi", value:`  >>> || ${msg.createdTimestamp - message.createdTimestamp} ||`, inline: true},
            
                {name: "<a:RainbowOkGif:869301898946158763> Discord API Pingi", value:`  >>>  || ${client.ws.ping} ||`, inline: true},

                {name: "<a:SabitGif:869301913089355857> Bot kaç sunucuda aktif?", value:`>>> || ${client.guilds.cache.size} ||`, inline: false},
